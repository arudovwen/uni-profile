...
export const apiPost = (url, data, config = {}) => axiosApi.post(url, data, config);
export const apiPut = (url, data, config = {}) => axiosApi.put(url, data, config);
...
export const mattaPost = (url, data, config = {}) => mattaApi.post(url, data, config);
...
export const ssoPost = (url, data, config = {}) => axiosSSO.post(url, data, config);
export const ssoPut = (url, data, config = {}) => axiosSSO.put(url, data, config);
