...
<style lang="scss">
.input-group-control {
  @apply bg-white transition duration-300 ease-in-out border border-slate-200 darks:border-slate-700 focus:ring-0  focus:outline-none  
...
.input-group-text {
  @apply bg-white  transition duration-300 ease-in-out  flex items-center justify-center px-3 border
