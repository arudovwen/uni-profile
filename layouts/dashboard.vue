        ...
        <div class="flex items-center justify-between py-4">
          ...
          <div class="relative" ref="userMenuRef">
            ...
            >
              <div
                v-if="isUserMenuOpen"
                class="absolute right-0 top-full mt-2 w-[173px] bg-white border border-[#F2F4F7] rounded-lg shadow-[0px_1px_3px_rgba(16,24,40,0.1),0px_1px_2px_rgba(16,24,40,0.06)] z-50"
              >
                <!-- User Info -->
